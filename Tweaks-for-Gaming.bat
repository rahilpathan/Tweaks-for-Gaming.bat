...
SC CONFIG Winmgmt start=demand & SC START Winmgmt
SC CONFIG TrustedInstaller start=demand & SC START TrustedInstaller
SC CONFIG AppInfo start=demand & SC START AppInfo
SC CONFIG DeviceInstall start=demand & SC START DeviceInstall
SC CONFIG Dhcp start=demand & SC START Dhcp
SC CONFIG w32time start=demand & SC START w32time
...
IF EXIST "%WINDIR%\procexp64.exe" REG ADD "HKLM\System\CurrentControlSet\Services\PCW" /v "Start" /t REG_DWORD /d "4" /f
IF EXIST "%WINDIR%\procexp64.exe" REG ADD "HKLM\Software\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\taskmgr.exe" /v "Debugger" /t REG_SZ /d "%WINDIR%\procexp64.exe" /f
...
REG ADD "HKLM\System\CurrentControlSet\Services\Dhcp" /v "DependOnService" /t REG_MULTI_SZ /d "" /f
...
REG ADD "HKLM\System\CurrentControlSet\Services\AFD" /v "Start" /t REG_DWORD /d "4" /f
...
:: Mouse fix
REG ADD "HKCU\Control Panel\Mouse" /v "SmoothMouseXCurve" /t REG_BINARY /d "0000000000000000703d0a0000000000e07a14000000000050b81e0000000000c0f5280000000000" /f
...
REG ADD add "HKCU\Control Panel\Mouse" /v "SmoothMouseYCurve" /t REG_BINARY /d "0000000000000000000038000000000000007000000000000000a800000000000000e00000000000" /f
...
REG ADD "HKCU\Control Panel\Mouse" /v "SmoothMouseYCurve" /t REG_BINARY /d "0000000000000000000038000000000000007000000000000000a800000000000000e00000000000" /f
:: Disabling mitigation
REG ADD "HKLM\System\CurrentControlSet\Control\Session Manager\kernel" /v "MitigationOptions" /t REG_BINARY /d "22222222222222222002000000200000" /f
REG ADD "HKLM\System\CurrentControlSet\Control\Session Manager\kernel" /v "MitigationAuditOptions" /t REG_BINARY /d "20000020202022220000000000000000" /f
)
...
del "c:\program files\google\chrome\application\85.0.4183.102\installer\chrmstp.exe"
sc delete gupdate
sc delete gupdatem
sc delete GoogleChromeElevationService
:: Notepad++
taskkill /f /im notepad++.exe
del /F /Q "%ProgramFiles%\Notepad++\updater"
:: Easy7zip
...
del "C:\Users\Public\Desktop\7-Zip File Manager.lnk"
:: Discord
...
attrib +r "%localappdata%\Discord\Update.exe"
:: Spotify
...
del /f/s/q "%appdata%\Spotify\Apps\Legacy-lyrics.spa"
del /f/s/q "%appdata%\Spotify\Apps\Lyrics.spa"
...
del /f/s/q "%appdata%\Spotify\locales\es.mo"
del /f/s/q "%appdata%\Spotify\locales\es.pak"
del /f/s/q "%appdata%\Spotify\locales\es-419.mo"
del /f/s/q "%appdata%\Spotify\locales\es-419.pak"
...
REG ADD "HKCU\Software\Sysinternals\Process Explorer" /v "PrcessColumnCount" /t REG_DWORD /d "12" /f
...
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumnMap" /v "8" /t REG_DWORD /d "1333" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumnMap" /v "9" /t REG_DWORD /d "1636" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumnMap" /v "10" /t REG_DWORD /d "4" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumnMap" /v "11" /t REG_DWORD /d "1670" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumnMap" /v "12" /t REG_DWORD /d "1670" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumnMap" /v "13" /t REG_DWORD /d "1670" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumnMap" /v "14" /t REG_DWORD /d "1670" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumnMap" /v "15" /t REG_DWORD /d "1670" /f
...
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumns" /v "8" /t REG_DWORD /d "65" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumns" /v "9" /t REG_DWORD /d "76" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumns" /v "10" /t REG_DWORD /d "31" /f
REG ADD "HKCU\Software\Sysinternals\Process Explorer\ProcessColumns" /v "11" /t REG_DWORD /d "32" /f
